...
Kanban board with project work log and AI/task integrations.
...
- **Project-manager sync** is optional. If `projects.json` is not present, the API serves projects/work log from `backend/data.json`.
